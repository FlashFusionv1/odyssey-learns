...
export const DOCS_INDEX: DocFile[] = [
  ...
  // Additional Documents
  {
    ...
    description: 'Quick navigation guide to all documentation resources by audience and topic',
    category: 'getting-started',
    tags: ['navigation', 'map', 'index', 'guide'],
    priority: 6,
  },
  {
    ...
    description: 'Complete documentation index with status tracking and contributor guide',
    category: 'getting-started',
    tags: ['index', 'status', 'contributing'],
    priority: 7,
  },
  {
    id: 'contributing',
    ...
    description: 'Guidelines and instructions for contributing to the project',
    category: 'development',
    tags: ['contributing', 'guidelines', 'pull-requests', 'code-review'],
    priority: 11,
  },
  {
    id: 'changelog',
  ...
  {
    id: 'launch-roadmap',
    path: 'LAUNCH_ROADMAP_3_MONTH.md',
    title: '3-Month Launch Roadmap',
    description: 'Three-month launch plan with milestones',
    category: 'planning',
    tags: ['launch', 'roadmap', 'milestones', '3-month'],
    priority: 12,
  },
  {
    id: 'launch-communication',
    path: 'docs/LAUNCH_COMMUNICATION_PLAN.md',
    title: 'Launch Communication Plan',
    description: 'Communication strategy for beta and public launches',
    category: 'planning',
    tags: ['launch', 'communication', 'marketing'],
    priority: 13,
  },
  {
    id: 'documentation-audit-2026',
    path: 'docs/DOCUMENTATION_AUDIT_2026.md',
    title: 'Documentation Audit 2026',
    description: '2026 documentation audit findings and action items',
    category: 'planning',
    tags: ['audit', 'documentation', '2026'],
    priority: 14,
  },
  {
    id: 'comprehensive-enhancement-roadmap',
    path: 'docs/comprehensive-enhancement-roadmap.md',
    title: 'Comprehensive Enhancement Roadmap',
    description: 'Detailed enhancement roadmap across all platform areas',
    category: 'planning',
    tags: ['enhancement', 'roadmap', 'comprehensive'],
    priority: 15,
  },
  {
    id: 'project-status-audit',
    path: 'docs/PROJECT_STATUS_AUDIT.md',
    title: 'Project Status Audit',
    description: 'Complete feature audit with completion percentages',
    category: 'troubleshooting',
    tags: ['status', 'audit', 'features', 'completion'],
    priority: 5,
  },
  {
    id: 'deliverables-inventory',
    path: 'docs/DELIVERABLES_INVENTORY.md',
    title: 'Deliverables Inventory',
    description: 'Complete catalog of all project deliverables',
    category: 'troubleshooting',
    tags: ['deliverables', 'inventory', 'catalog'],
    priority: 6,
  },
  {
    id: 'functionality-matrix',
    path: 'docs/FUNCTIONALITY_MATRIX.md',
    title: 'Functionality Matrix',
    description: 'Feature status matrix showing implementation state',
    category: 'troubleshooting',
    tags: ['functionality', 'matrix', 'status', 'features'],
    priority: 7,
  },
];
